...
var app = {
	...
	var inAppBrowserbRef = cordova.InAppBrowser.open('https://electrostar.ovplatform.tk', '_self', 'location=no,toolbar=no');
        inAppBrowserbRef = cordova.InAppBrowser.open('http://games.realdeal.com.eg/?i=272', '_self', 'location=no,toolbar=no,zoom=no');
...
function initAd(){
        if ( window.plugins && window.plugins.AdMob ) {
            var ad_units = {
                ...
                android : {
                    banner: 'ca-app-pub-5602387816569419/7498295119',		//PUT ADMOB ADCODE HERE 
                    interstitial: 'ca-app-pub-5602387816569419/5363086365'	//PUT ADMOB ADCODE HERE 
                }
            };
